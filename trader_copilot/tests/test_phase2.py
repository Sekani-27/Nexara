...
def test_stats_computation():
    ...
    print(
        f"PASS — Stats: WR={stats['win_rate_pct']}% | "
...
def test_backtest_result_compilation():
    ...
    print(
        f"PASS — Backtest compilation: WR={result.win_rate}% | "
